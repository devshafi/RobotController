...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btConditionText = (TextView) findViewById(R.id.btContionText);
        btSwitch = (SwitchCompat) findViewById(R.id.btSwitch);
        btConditionImage = (ImageView) findViewById(R.id.btConditionImage);
        ...
        searchProgressDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Cancel", new DialogInterface.OnClickListener() {
    ...
    // we are taking more decision based on if user turned on bluetooth or not
    @Override
